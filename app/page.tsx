...
export default function Home() {
  ...
  return (
    <main className="flex flex-col items-center justify-between pt-8 sm:pt-24 px-4 sm:px-8 lg:px-16 w-full">
      ...
      <div className="h-full w-full mx-auto overflow-y-auto flex flex-col items-center justify-center gap-3">
